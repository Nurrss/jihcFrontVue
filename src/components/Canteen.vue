<template>
  ...
  <div class="text-center">
    <div class="container">
      <h2 class="m-5" style="color: #0077ff">Столовая</h2>
      <p class="lead m-0">
        Столовая нашего университета предлагает разнообразные и вкусные блюда
        для студентов. Здесь вы можете насладиться балансом здорового питания и
        уютной обстановкой, создавая идеальное место для обедов и общения.
      </p>
    </div>
  </div>
</template>
