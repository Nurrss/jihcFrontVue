<template>
  ...
  <div class="text-center">
    <div class="container">
      <h2 class="m-5" style="color: #0077ff">Общежитие</h2>
      <p class="lead m-0">
        Общежитие колледжа предоставляет студентам удобное и безопасное жилье в
        непосредственной близости от учебных помещений, создавая благоприятные
        условия для полноценной учебы и социальной активности. В общежитии
        университета доступны, а также уютные чайные комнаты, создавая
        благоприятные условия для отдыха и общения студентов.
      </p>
    </div>
  </div>
</template>
