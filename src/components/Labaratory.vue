<template>
  ...
  <div class="text-center">
    <div class="container">
      <h2 class="m-5" style="color: #0077ff">Лаборатории</h2>
      <p class="lead m-0">
        Лаборатория нашего учебного заведения предоставляет студентам уникальную
        возможность воплотить теоретические знания в практический опыт. Студенты
        могут расширять свой академический опыт, разрабатывать собственные
        проекты и глубже понимать принципы науки, работая в нашей инновационной
        лаборатории.
      </p>
    </div>
  </div>
