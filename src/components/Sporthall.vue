<template>
  ...
  <div class="text-center">
    <div class="container">
      <h2 class="m-5" style="color: #0077ff">Спорзал + поле</h2>
      <p class="lead m-0">
        У нас на кампусе есть современное футбольное поле, идеально подходящее
        для тренировок и матчей. Также у нас есть просторный спортивный зал,
        оборудованный технологиями, где студенты могут заниматься различными
        видами спорта для поддержания физической активности и здоровья.
      </p>
    </div>
  </div>
</template>
