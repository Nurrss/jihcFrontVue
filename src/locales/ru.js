export default {
  ...
  AssocP10:
    "Ассоциация регулярно организует разнообразные мероприятия. Эти активности включают в себя встречи, футбол среди мужчин, и соревнования, способствуя не только обмену опытом, но и поддерживая дружбу и сеть профессиональных контактов.",
  AssocP11:
  ...
  CorpusH: "Корпус",
  CorpusP:
    "Наш корпус – это вдохновляющее место, где студенты находят идеальное сочетание образования и общественной активности. Наш корпус и аудитории обладают инновационным дизайном, способствующим современному образовательному опыту.",
  // CanteenPage Texts
  CantennPage: {
    title: "Столовая",
  ...
  Fact6H: "47",
  Fact6P: "выпускников отучились в топ 200 вузах мира ",
  Fact7H: "37%",
  ...
  // Column,
  ColumnD1P1: "Качественное",
  ColumnD1P2: "образование",
  ColumnD2P1: "Разумное",
  ColumnD2P2: "воспитание",
  ColumnD3P1: "Обучение",
  ...
  Column2P1: "Инновационные технологии",
  Column2P2: "Учителя, получившие образование за рубежом",
  Column2P3: "Занятия проводятся на базе WorldSkills Competence",
  ...
  ThirdNavNavItem6Li3: "Связь с учителем",
